        ...
        <Card className="max-w-4xl w-full">
          <CardContent className="p-8 md:p-12">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              <Button 
                size="lg" 
                className="h-auto px-4 py-2.5 text-base bg-black hover:bg-gray-900 text-white rounded-xl flex items-center justify-start gap-2.5 border-2 border-green-500/50 w-56"
                onClick={() => {
              ...
              <Button 
                size="lg" 
                className="h-auto px-4 py-2.5 text-base bg-gray-700 cursor-not-allowed text-white rounded-xl flex items-center justify-start gap-2.5 border-2 border-gray-600 opacity-75 w-56"
                disabled
              >
