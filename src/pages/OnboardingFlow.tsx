...
const OnboardingFlow = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50">
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-blue-900 via-blue-800 to-slate-900 text-white relative overflow-hidden py-12">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-8">
          <div className="text-center max-w-5xl mx-auto space-y-6">
            ...
            <p className="text-base md:text-lg text-blue-100 leading-relaxed max-w-4xl mx-auto">
              Most rewards cards are built for categories, not people. Ventus is here to change that. 
              <br />
              We start with your personal goals: like getting healthier, training for your next race, or just taking better care of your dog or home, we then build rewards and curate deals around the things you actually care about. Ventus will find the right offers for you, no more switching cards or missing out on rewards.
            </p>
          </div>
        </div>
      ...
      <div className="flex-grow">
        <div className="max-w-7xl mx-auto px-6 md:px-8 py-8">
          ...
          {/* Step Content */}
          <div className="bg-white rounded-2xl shadow-lg p-6 md:p-8 mb-8 border border-slate-100 touch-manipulation" 
          ...
          <div className="flex justify-between items-center max-w-2xl mx-auto">
            {step > 1 ? (
              <Button 
                ...
                className="flex items-center gap-2 px-6 py-3 font-medium border-slate-300 hover:bg-slate-100 hover:text-slate-800 transition-all duration-200 min-h-[48px] min-w-[120px] touch-manipulation" 
            ...
            {step < totalSteps ? (
              <Button 
                ...
                className={`flex items-center gap-2 px-8 py-3 font-semibold bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 shadow-lg transition-all duration-200 min-h-[48px] min-w-[120px] touch-manipulation ${
