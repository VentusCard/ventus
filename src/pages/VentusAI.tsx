...
import { Brain, Target, TrendingUp, Shield, ArrowRight, Sparkles, MapPin } from "lucide-react";
...
const VentusAI = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-[45vh] flex flex-col items-center justify-center px-4 md:px-8 pt-36 md:pt-44 lg:pt-52 pb-22">
      ...
      <section className="py-16 px-4 md:px-8 max-w-7xl mx-auto text-center border-t border-border/50">
        <Card className="glass-transition-card max-w-4xl mx-auto p-8 md:p-12 !bg-[hsl(var(--card))]">
          ...
          <Link to="/app">
            <Button size="lg" className="px-10 py-6 text-lg rounded-full">
              Try Free Ventus AI Deal Finder App
