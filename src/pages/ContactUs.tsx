    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50">
      ...
      <div className="px-4 md:px-8 pb-16">
        <div className="max-w-2xl mx-auto relative">
              ...
              <form className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input name="name" placeholder="Enter your full name" className="h-12" required />
                  </div>
                  <div>
                    <label className="text-slate-700 font-medium mb-2 block">Email Address</label>
                    <Input name="email" type="email" placeholder="your.email@example.com" className="h-12" required />
                  </div>
                </div>

                <div>
                  <label className="text-slate-700 font-medium mb-2 block">Subject</label>
                  <Input name="subject" placeholder="How can we help?" className="h-12" required />
                </div>

                <div>
                  <label className="text-slate-700 font-medium mb-2 block">Message</label>
                  <Textarea name="message" placeholder="Please share your questions or feedback..." className="min-h-32 resize-none" required />
                </div>

                <div className="flex justify-center">
                  <Button type="button" onClick={handleMailTo} variant="outline" className="h-12 border-2 border-blue-600 text-blue-600 hover:bg-blue-50 font-semibold rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-[1.02]">
          ...
          {/* Success Overlay */}
          {showSuccessOverlay && (
            <div className="absolute inset-0 bg-white/95 backdrop-blur-sm rounded-xl border-0 shadow-xl flex items-center justify-center z-10">
              <div className="text-center p-8 max-w-md">
                <CheckCircle className="w-16 h-16 text-green-600 mx-auto mb-4" />
                <h3 className="text-2xl font-bold text-slate-900 mb-4">Email Client Opened</h3>
