        ...
        <div className="space-y-6">
          <Card className="overflow-hidden border-0 bg-gradient-card shadow-xl hover-lift">
            ...
            <CardContent className="p-6">
              <h3 className="font-display text-xl font-bold mb-4 flex items-center gap-2 text-white">
              ...
              <div className="space-y-5">
                <div>
                  <p className="text-sm text-sky-300 mb-1">Main Goal</p>
                  <div className="flex items-center gap-2 bg-blue-900/50 p-2 rounded-md border border-blue-800">
                    ...
                    <p className="font-medium text-white">{onboardingData.mainGoal?.charAt(0).toUpperCase() + onboardingData.mainGoal?.slice(1)}</p>
                  </div>
                </div>
                
                <div>
                  <p className="text-sm text-sky-300 mb-1">Selected Interests</p>
                ...
                <div>
                  <p className="text-sm text-sky-300 mb-1">Estimated Annual Spend</p>
          ...
          <Card className="overflow-hidden border-0 bg-gradient-to-r from-indigo-900 to-blue-900 text-white shadow-xl hover-lift">
            ...
            <CardContent className="p-6">
              ...
              <div className="space-y-6">
                <div>
                  <p className="text-sm text-sky-200 mb-1">Estimated Annual Points</p>
                  <div className="flex items-center gap-3 mb-2">
                    <p className="font-bold text-3xl text-white">{onboardingData.estimatedPoints.toLocaleString()}</p>
                    <div className="bg-glass text-xs px-2 py-1 rounded-full text-sky-100">
                      +5x on categories
                    </div>
                  </div>
                  <div className="mb-3">
                  ...
                  <p className="text-xs text-sky-200">Equal to approximately {formatCurrency(onboardingData.estimatedPoints / 100)}</p>
                </div>
                
                <div>
                  <p className="text-sm text-sky-200 mb-1">Approximate Savings</p>
            ...
            <CardContent className="p-6">
              ...
              <div className="space-y-5">
                <div className="flex gap-3 bg-blue-900/40 p-3 rounded-lg transition-all hover:bg-blue-900/60 hover:translate-x-1 border border-blue-800/50">
                  ...
                  <div>
                    <p className="font-medium text-sky-100">5x Points Categories</p>
                ...
                <div className="flex gap-3 bg-blue-900/40 p-3 rounded-lg transition-all hover:bg-blue-900/60 hover:translate-x-1 border border-blue-800/50">
                  ...
                  <div>
                    <p className="font-medium text-sky-100">Exclusive Partner Offers</p>
                    <p className="text-sky-200 text-sm">
                ...
                <div className="flex gap-3 bg-blue-900/40 p-3 rounded-lg transition-all hover:bg-blue-900/60 hover:translate-x-1 border border-blue-800/50">
                  ...
                  <div>
                    <p className="font-medium text-sky-100">Personalized Rewards Dashboard</p>
                    <p className="text-sky-200 text-sm">
                ...
                <div className="flex gap-3 bg-blue-900/40 p-3 rounded-lg transition-all hover:bg-blue-900/60 hover:translate-x-1 border border-blue-800/50">
                  ...
                  <div>
                    <p className="font-medium text-sky-100">Quarterly Bonus Opportunities</p>
                    <p className="text-sky-200 text-sm">
                ...
                <div className="flex gap-3 bg-blue-900/40 p-3 rounded-lg transition-all hover:bg-blue-900/60 hover:translate-x-1 border border-blue-800/50">
                  ...
                  <div>
                    <p className="font-medium text-sky-100">Multiple Redemption Options</p>
                    <p className="text-sky-200 text-sm">
      ...
      <Card className="overflow-hidden border-0 shadow-xl bg-gradient-card-accent">
        ...
        <CardContent className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <div>
              <label className="block text-sm font-medium mb-1 text-sky-100">First Name</label>
              <Input placeholder="First Name" className="bg-blue-900/50 border-blue-800 focus:border-blue-600 text-white placeholder:text-sky-300/70" />
            </div>
            
            <div>
              <label className="block text-sm font-medium mb-1 text-sky-100">Last Name</label>
              <Input placeholder="Last Name" className="bg-blue-900/50 border-blue-800 focus:border-blue-600 text-white placeholder:text-sky-300/70" />
            </div>
            
            <div>
              <label className="block text-sm font-medium mb-1 text-sky-100">Main Category</label>
              <Select>
                <SelectTrigger className="bg-blue-900/50 border-blue-800 focus:border-blue-600 text-white">
                  <SelectValue placeholder="Select a category" className="text-sky-300/70" />
                </SelectTrigger>
                <SelectContent className="bg-blue-950 border-blue-800">
                  {lifestyleCategories.map((category) => (
                    <SelectItem key={category.value} value={category.value} className="text-white focus:bg-blue-900 focus:text-sky-50">
                      {category.label}
                    </SelectItem>
                  ))}
                </SelectContent>
            ...
            <div className="md:col-span-3">
              <label className="block text-sm font-medium mb-1 text-sky-100">Email Address</label>
              <Input placeholder="Email Address" className="bg-blue-900/50 border-blue-800 focus:border-blue-600 text-white placeholder:text-sky-300/70" />
            </div>
          </div>
          
          <Button className="bg-gradient-glow hover:from-blue-500 hover:to-blue-600 shadow-lg shadow-blue-600/20 transition-all duration-200 text-white">
            Join the Waitlist
          </Button>
        </CardContent>
      </Card>
