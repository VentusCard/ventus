        ...
        {prompts.map((prompt, index) => {
          ...
          return (
            <Button
              ...
              disabled={isLoading}
              className="justify-start text-left h-auto py-2.5 px-3 hover:bg-primary/5 hover:border-primary/50 transition-all duration-200 hover:scale-[1.02] group"
            >
              <Icon className="w-3.5 h-3.5 mr-2 flex-shrink-0 text-primary/70 group-hover:text-primary transition-colors" />
