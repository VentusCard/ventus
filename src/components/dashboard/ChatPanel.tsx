...
export const ChatPanel = ({ messages, isLoading, onSendMessage }: ChatPanelProps) => {
  ...
  return (
    <div className="h-full flex flex-col bg-gradient-to-br from-background via-background/95 to-primary/5 backdrop-blur-sm border-r">
      <div className="p-6 border-b bg-card/50 backdrop-blur-sm">
        <h2 className="text-2xl font-bold">Deal Finder AI</h2>
