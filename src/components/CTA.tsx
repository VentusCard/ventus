...
const CTA = () => {
  return (
    <section className="relative bg-black text-white">
      ...
      <div className="absolute top-0 left-0 right-0 h-16 bg-gradient-to-b from-[#F8F9FA] via-[#2A2A2A] to-[#000000] pointer-events-none"></div>
      ...
      <div className="relative pt-20 pb-6">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-lg opacity-90 max-w-2xl mx-auto mb-6 animate-[fadeUpSoft_1s_ease-out] opacity-0 [animation-delay:0.4s] [animation-fill-mode:forwards]">
