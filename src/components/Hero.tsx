...
const Hero = () => {
  ...
  const handleGetStarted = () => {
    ...
    // Smooth scroll to the new content section
    setTimeout(() => {
  ...
  return (
    <>
      ...
      {/* New Content Section with fade-in effect */}
      <div 
        id="hero-content"
        className={`bg-white min-h-screen transition-all duration-1000 ${
      ...
      >
        ...
        <div className="max-w-6xl mx-auto px-6 md:px-8 py-20">
          <div className="text-center">
            <h2 className="font-display text-4xl md:text-5xl lg:text-6xl font-light text-black mb-8">
              Welcome to the Future
            </h2>
            <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Experience a new era of personalized rewards that adapt to your lifestyle. 
              Join thousands who have already transformed their spending into meaningful benefits.
            </p>
          </div>
        </div>
      </div>
