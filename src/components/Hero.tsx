...
const Hero = () => {
  ...
  return (
    <div id="hero" className="relative text-white flex items-center justify-center overflow-hidden min-h-screen pt-20 bg-black">
          ...
          <div className="relative w-full max-w-2xl md:max-w-3xl mx-auto transform scale-60 md:scale-65 lg:scale-70 transition-all duration-700 ease-out">
            <div className="relative aspect-video overflow-hidden">
              ...
              <div className="absolute inset-0 z-10 pointer-events-none">
                ...
                <div className="absolute top-0 left-0 right-0 h-8 md:h-12 bg-gradient-to-b from-background via-background/60 to-transparent"></div>
                <div className="absolute bottom-0 left-0 right-0 h-12 md:h-16 bg-gradient-to-t from-background via-background/80 to-transparent"></div>
                <div className="absolute top-0 bottom-0 left-0 w-8 md:w-12 bg-gradient-to-r from-background via-background/60 to-transparent"></div>
                <div className="absolute top-0 bottom-0 right-0 w-8 md:w-12 bg-gradient-to-l from-background via-background/60 to-transparent"></div>
            ...
            <div className="absolute -inset-8 md:-inset-12 bg-gradient-radial from-background/10 via-background/30 to-background opacity-60 blur-3xl -z-10"></div>
          </div>
