      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
        ...
        const getCardStyles = () => {
          ...
          if (option.id === 'sports') {
            ...
            const baseStyles = 'bg-gradient-to-br from-blue-900/90 to-slate-900/93 border border-blue-700/80';
            const hoverStyles = 'hover:from-blue-800/95 hover:to-slate-900/98 hover:border-blue-600/85';
