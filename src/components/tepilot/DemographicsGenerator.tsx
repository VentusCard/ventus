...
export function DemographicsGenerator({ 
  ...
  // No demographics - show generate button and editable fields
  if (!demographics) {
    return (
      <div className="space-y-2">
        ...
        <div className="p-3 bg-slate-50 border border-slate-200 rounded-lg space-y-3">
          ...
          <Button
            ...
            className="w-full border-dashed border-slate-300 text-slate-600 hover:bg-slate-100 hover:text-slate-900"
          >
            {isGenerating ? (
  ...
  // Sample data loaded - show read-only demographics
  if (isFromSampleData) {
    return (
      <div className="space-y-2">
        <label className="text-sm font-medium flex items-center gap-1.5 text-slate-900">
  ...
  // User-generated demographics - show editable fields
  return (
    <div className="space-y-2">
      <label className="text-sm font-medium flex items-center gap-1.5 text-slate-900">
        <Sparkles className="h-3.5 w-3.5 text-blue-600" />
      ...
      <div className="p-3 bg-slate-50 border border-slate-200 rounded-lg space-y-3">
        <div className="flex items-center gap-3 flex-wrap">
          ...
          <div className="flex items-center gap-1.5">
            ...
            >
              <SelectTrigger className="w-[140px] h-8 bg-white border-slate-300 text-sm">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
          ...
          <div className="flex items-center gap-1.5">
            ...
            >
              <SelectTrigger className="w-[180px] h-8 bg-white border-slate-300 text-sm">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button
                  ...
                  onClick={handleGenerate}
                  disabled={isGenerating}
                  className="h-8 px-3 text-slate-500 hover:text-slate-900"
                >
              ...
              <TooltipContent>
                <p className="text-xs">Generate new random profile</p>
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
                <Button
                  ...
                  size="sm"
                  onClick={handleClear}
                  className="h-8 px-3 text-slate-500 hover:text-red-600"
                >
              ...
              <TooltipContent>
                <p className="text-xs">Clear customer context</p>
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
        </div>
